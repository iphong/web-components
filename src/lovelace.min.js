...
class ExampleCard extends HTMLElement {
	constructor() {
		...
		_defineProperty(this, "storedValues", []);

		_defineProperty(this, "handleAction", e => {
			const {
				hass,
				config
			} = this;
			...
			if (entity_id) {
				...
				for (let service in services) {
					entity[service] = data => hass.callService(domain, service, _objectSpread({
						entity_id
					}, data));
				}
			}
